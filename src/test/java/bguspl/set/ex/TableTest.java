...
class TableTest {
    ...
    @Test
    //This test checks the placing of cards and the counting of them
    void placeAndCountCards() {
        assertEquals(0,table.countCards(),"table has been started not empty!");
        table.placeCard(1,1);
        assertEquals(1, table.countCards(),"card has not been placed!");
    }

    @Test
    //This test checks the placing and removing of cards succesfully
    void placeAndRemoveCards() {
        assertEquals(0, table.countCards(),"table has been started not empty!");
        table.placeCard(1,1);
        assertEquals(1, table.countCards(),"card has not been placed!");
        table.removeCard(1);
        assertEquals(0, table.countCards(),"card has not been removed!");
    }
